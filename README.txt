...
This plugin will allow premium Shorthand users to connect their Wordpress installation to Shorthand (http://shorthandapp.com).  This will allow users to single click publish Shorthand stories into Wordpress.

== Installation ==

1. Upload `plugin-name.php` to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go to Settings > Shorthand and enter in your user ID and API Key.
