...
var options = {
  ...
  item: '<li class="story"><label><input class="story_id" name="story_id" type="radio" value=""/><input class="description" name="description" type="hidden" value=""/><img class="image imagealt" width="190" src="" alt=""/><span class="version">Story version: <span class="version_value"></span></span><span class="title"></span><div class="updated_container">Updated: <span class="updated_timestamp updated_value"></span> ago</div><div class="published_container">Last published: <span class="published_timestamp published_value"></span> ago</div></label></li>'
};

var storiesList = new List('stories-list', options);
